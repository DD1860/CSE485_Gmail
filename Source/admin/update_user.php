<?php
    ...
    $sql = "UPDATE db_nhanvien SET hovaten='$hoTen', chucvu='$chucVu', sodt_coquan = '$soMayBan', sodt_diddong = '$soDiDong', email='$email', ma_donvi = '$maDonVi' WHERE ma_nhanvien = '$maNhanVien'";
    // echo $sql;
